...
quests = {
    "Вкусная Контрабанда 🍭": {
        ...
        "puzzles": [
            ...
            {"image": None,
             "description": "Наши следователи что-то докладывают...\nМЫ НАШЛИ ЗАПИСКУ 📝!!!\n\nВ записке преступник написал следующее: ```Вечером на нулевом километре, туда куда смотрит *S*, долго ждать не буду```. \n\nЧто это значит? Найдите это место и доложите, что вы нашли",
             "options": [],
